...
five-way-union sentence now reads "the practice [Retrofitting an
Effect] recommends", the conclusion counts two checker gaps, and the
ch46 paragraph, CLAUDE.md, both skill copies, and project memory were
modernized to match. Nothing further to apply from this block.)
