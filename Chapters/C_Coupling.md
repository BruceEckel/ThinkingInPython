...
This appendix makes that measure visible.
Once you can see coupling,
the patterns in [Part III](21_Patterns--Design_Patterns.md)
stop being twenty-three shapes to memorize and become a few moves applied to one kind of diagram.
...
That is the mechanism behind [When a Pattern Dissolves](21_Patterns--Design_Patterns.md#when-a-pattern-dissolves):
...
That is the content of the *Managed Coupling* principle in [Design Principles](21_Patterns--Design_Patterns.md#design-principles):
...
A design's coupling is the pattern of filled cells, and a pattern moves cells:
usually out of the rows that change often and into one row you can find.
