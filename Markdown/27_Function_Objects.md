...
written as frozen data classes (see [Data Classes as Types](10_Data_Classes_as_Types.md#immutability)).
...
This is the *Observer* pattern (see [Observer](29_Observer.md#the-pythonic-observer-a-list-of-callables)) narrowed to a single subject:
...
which [Visitor](31_Visitor.md#the-pythonic-visitor-singledispatch) and [Pattern Refactoring](32_Pattern_Refactoring.md#adding-operations-visitor-and-why-python-skips-it) put to work.
