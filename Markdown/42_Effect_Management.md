...
A *Total Function* doesn't raise exceptions, but instead returns errors as data using explicit wrapper types, as we saw in [Functional Error Handling](14_Functional_Error_Handling.md).
