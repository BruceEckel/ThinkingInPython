...
Python has no `final` keyword ([Singleton](21_Singleton.md) and [Metaprogramming](16_Metaprogramming.md#making-a-class-final) show how it is emulated when truly needed),
