...
The [Data Classes as Types](10_Data_Classes_as_Types.md) chapter made a value
...
[Static Type Checking](08_Static_Type_Checking.md) chapter: put the meaning in
the type.
...
that combining returns the right value. See the [Testing](09_Testing.md)
